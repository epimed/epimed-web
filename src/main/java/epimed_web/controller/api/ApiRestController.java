...
@RestController
public class ApiRestController extends ApplicationLogger {
	...
	public void downloadGse(
		...
		String fileName =  fileService.generateFileName("EpiMed_experimental_grouping", listIdSeries, 3, "SEVERAL_STUDIES", "csv");
